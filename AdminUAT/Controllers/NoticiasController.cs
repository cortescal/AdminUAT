...
namespace AdminUAT.Controllers
{
    public class NoticiasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Descripcion,Activo,AltaSistema")] Noticia noticia)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Titulo,Descripcion,Activo,AltaSistema")] Noticia noticia)
        {
            if (id != noticia.Id)
            {
                return NotFound();
